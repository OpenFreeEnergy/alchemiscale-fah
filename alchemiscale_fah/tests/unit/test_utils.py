...
def test_generate_project_atom_counts(lower, upper, n_projects, nonbonded_settings):
    ...
    project_atom_counts = utils.generate_project_atom_counts(lower, upper, n_projects, nonbonded_settings)
    ...
    expected_project_efforts = np.linspace(effort_func(lower), effort_func(upper), n_projects)
