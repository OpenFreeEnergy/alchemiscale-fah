...
class FahComputeServiceIndex:
    ...
    def set_clone(self, project_id: str, run_id: str, clone_id: str, fah_clone: FahClone):
    ...
    def get_transformation(self, transformation: GufeKey) -> Tuple[Optional[str], Optional[str]]:
    ...
    def get_task(self, task: ScopedKey) -> Tuple[Optional[str], Optional[str], Optional[str]]:
